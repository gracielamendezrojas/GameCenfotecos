        ...
        for(int y = 0; y < 3; y++) {
            for (int x = 0; x < 3; x++) {
                ...
                if(y==1 || y ==2){
                    Square _PrefaClon = _Square.clone();
                    _PrefaClon.setId(6);
                    _PrefaClon.set_X((float) (1 * ASquare._SIZE_PREFA) + ASquare._PREFA_X);
                    _PrefaClon.set_Y((float) (y * ASquare._SIZE_PREFA) + ASquare._PREFA_Y);
                    _ListaPrefa.add(_PrefaClon);
                }
            }
        ...
        for(int y = 0; y < 3; y++) {
            for (int x = 0; x < 3; x++) {
                ...
                if(y==0 || y == 2 ) {
                    Square _PrefaClon = _Square.clone();
                    _PrefaClon.setId(6);
                    _PrefaClon.set_X((float) (0 * ASquare._SIZE_PREFA) + ASquare._PREFA_X);
                    _PrefaClon.set_Y((float) (y * ASquare._SIZE_PREFA) + ASquare._PREFA_Y);
        ...
        for(int y = 0; y < 3; y++) {
            for (int x = 0; x < 3; x++) {
                ...
                if(y==0 || y ==2) {
                    Square _PrefaClon = _Square.clone();
                    _PrefaClon.setId(6);
                    _PrefaClon.set_X((float) (2 * ASquare._SIZE_PREFA) + ASquare._PREFA_X);
                    _PrefaClon.set_Y((float) (y * ASquare._SIZE_PREFA) + ASquare._PREFA_Y);
